    ...
    <div className="App">
      <Router>
        ...
        <Routes>
          ...
          />} />
          <Route path="/dsjpiwnwecbrnwr" element={<Admin setClientId={setClientId} clientId={clientId} clients={clients} getClients={getClients} getPhones={getPhones} phones={phones} setPhones={setPhones} />} />
